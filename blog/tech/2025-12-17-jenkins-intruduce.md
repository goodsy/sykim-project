...
Quartz 단독 구조에서는 이 세 가지가 **운영 관점에서 명확히 구분되지 않았다.**

> 결과적으로는 모두 **"정산 배치가 안 돈다"** 로 보이기 때문이다.
...
Quartz로만 시스템을 운영하기에는 **정산·회계 배치 운영에는 부족한 부분이 있었다.**
...
운영자가 **UI 기준으로 안전하게 재실행**할 수 있게 된다.
...
> Quartz 단독보다 **Jenkins 연계 구조가 운영하기에 적합**하지 않을까 생각한다.
> 
