...
단순한 구현 문제가 아니라 **정합성·재현성·장애 여부**를 좌우합니다.

이 문서는 실무 정산 시스템 기준에서  
**금액 / 수수료 / 세금 타입을 어떻게 설계해야 하는지**를 간단히 정리한 내용입니다.

---

## 기본 원칙 요약

정산 시스템의 금액 타입 설계는 아래 원칙을 따릅니다.
...
> “정확한 계산”보다 더 중요한 건 **항상 같은 결과가 나오는 계산**입니다.
...
👉 **“입력은 정수, 계산은 BigDecimal”** 구조가 가장 안정적입니다.
...
✔ 정산 시스템에서 금액은 화폐 단위의 사실값(source of truth) 입니다.
...
- 승인금액(long): “원장이 준 사실값”이라서 변형 없이 단순·빠르게 들고 감
